...
class Fraction:
    ...
    def __rsub__(self, other):
        ...
        numerator_2, denominator_2 = other.our_numerator, other.our_denominator
        our_nok = nok(denominator_2, self.our_denominator)
        return Fraction(other.our_numerator * our_nok // other.our_denominator
                        - self.our_numerator * our_nok // self.our_denominator, our_nok)

    def __rtruediv__(self, other):
        other = transition(other)
        return Fraction(other.our_numerator * self.our_denominator,
                        self.our_numerator * other.our_denominator)
